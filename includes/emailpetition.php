	...
	if ( isset( $attr['id'] ) && is_numeric( $attr['id'] ) ) {
		...
		if ( $petition_exists ) {
			...
			if ( ! $expired ) {
                ...
                <label class = "required" for="dk-speakup-accept-' . $petition->id . '"> Acepto los <a href="#final">términos de uso</a> </label><br />
				...
				$petition_form .= '<div class="dk-speakup-response"></div>';
